-- ===================================================
-- SISTEMA DE REFUGIOS - COMPLETE DATABASE SCHEMA
-- ===================================================
...
INSERT INTO Usuarios (username, password_hash, rol, nombre_mostrado) 
VALUES ('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrador', 'Administrador del Sistema');

-- Insert sample refugio
INSERT INTO Refugios (nombre_refugio, ubicacion, fecha_apertura, capacidad_maxima)
VALUES 
('Refugio Central', 'Av. Principal 123, Centro, Ciudad', CURDATE(), 100),
('Refugio Norte', 'Calle Norte 456, Zona Norte', CURDATE(), 150),
('Refugio Sur', 'Av. Sur 789, Zona Sur', CURDATE(), 80);

-- Insert sample refugio users
INSERT INTO Usuarios (username, password_hash, rol, refugio_id, nombre_mostrado)
VALUES 
('refugio_central', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Refugio', 1, 'Operador Refugio Central'),
('refugio_norte', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Refugio', 2, 'Operador Refugio Norte'),
('auditor', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Auditor', NULL, 'Auditor del Sistema');
...
('Carlos Rodríguez', 'Adulto mayor', 'M', 'Español'),
('Sofia Martinez', 'Adolescente', 'F', 'Español');

-- Insert sample procedencia data
INSERT INTO Procedencia (persona_id, localidad, municipio, situacion, tiene_mascotas) VALUES
(1, 'Barrio Centro', 'Ciudad Principal', 'Vivienda perdida', FALSE),
(2, 'Zona Industrial', 'Ciudad Principal', 'Temporalmente desplazado', TRUE),
(3, 'Barrio Centro', 'Ciudad Principal', 'Vivienda perdida', FALSE),
(4, 'Villa Esperanza', 'Municipio Norte', 'Evacuación preventiva', FALSE),
(5, 'Colonia Sur', 'Ciudad Sur', 'Temporalmente desplazado', FALSE);

-- Insert sample salud data
INSERT INTO Salud (persona_id, condicion_medica, requiere_atencion_urgente) VALUES
(4, 'Diabetes tipo 2, hipertensión', TRUE),
(2, 'Asma bronquial', FALSE);

-- Create sample registrations using the stored procedure
CALL sp_registrar_ingreso(1, 1, CURDATE(), '10:30:00', 'Área A-1', 'Alojado', 'Ingreso con familia', 1, '127.0.0.1');
CALL sp_registrar_ingreso(2, 1, CURDATE(), '10:35:00', 'Área A-1', 'Alojado', 'Esposo de María González', 1, '127.0.0.1');
CALL sp_registrar_ingreso(3, 1, CURDATE(), '10:35:00', 'Área A-1', 'Alojado', 'Hija de María González', 1, '127.0.0.1');
CALL sp_registrar_ingreso(4, 2, CURDATE(), '14:15:00', 'Área B-2', 'Alojado', 'Requiere atención médica', 2, '127.0.0.1');
CALL sp_registrar_ingreso(5, 2, CURDATE(), '16:45:00', 'Área B-3', 'Alojado', 'Adolescente sin acompañante', 2, '127.0.0.1');

-- Create sample family group
CALL sp_crear_grupo(1, 'Familia González-Pérez', 1);
CALL sp_agregar_miembro_grupo(1, 2, 'Esposo/a', 1);
CALL sp_agregar_miembro_grupo(1, 3, 'Hijo/a', 1);
